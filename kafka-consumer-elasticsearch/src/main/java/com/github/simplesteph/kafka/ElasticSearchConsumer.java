...
public class ElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient(){
		...
		/*
		 * String hostname = "kafka-cluster-6042906627.ap-southeast-2.bonsaisearch.net";
		 * // localhost or bonsai url String username = "ztjd8tvgk6"; // needed only for
		 * bonsai String password = "lr4bsa5co1"; // needed only for bonsai
		 * 
		 * // credentials provider help supply username and password final
		 * CredentialsProvider credentialsProvider = new BasicCredentialsProvider();
		 * credentialsProvider.setCredentials(AuthScope.ANY, new
		 * UsernamePasswordCredentials(username, password));
		 * 
		 * RestClientBuilder builder = RestClient.builder( new HttpHost(hostname, 443,
		 * "https")) .setHttpClientConfigCallback(new
    ...
    public static KafkaConsumer<String, String> createConsumer(String topic){
        ...
        properties.setProperty(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, "6"); // disable auto commit of offsets
    ...
    public static void main(String[] args) throws IOException {
        ...
        KafkaConsumer<String, String> consumer = createConsumer("second-topic");
            ...
            for (ConsumerRecord<String, String> record : records){
                ...
                try {
                    ...
                    */
                    ...
                    IndexRequest indexRequest = new IndexRequest("second-topic-index")
                       .source("{\"value\":\""+record.value()+"\"}", XContentType.JSON)
